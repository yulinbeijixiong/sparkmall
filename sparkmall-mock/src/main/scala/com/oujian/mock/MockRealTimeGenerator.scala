package com.oujian.mock

import java.util.Properties

import com.oujian.mock.bean.CityInfo
import com.oujian.mock.util.{PropertiesUtil, RanOpt, RandomOptions}
