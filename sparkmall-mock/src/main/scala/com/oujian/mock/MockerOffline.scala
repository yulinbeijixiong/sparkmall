...
import com.oujian.mock.bean.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
import org.apache.spark.SparkConf
import org.apache.spark.sql.SparkSession
import com.oujian.mock.util.{PropertiesUtil, RanOpt, RandomDate, RandomNum, RandomOptions}
...
object MockerOffline {
  ...
  def insertHive(sparkSession: SparkSession, tableName: String, dataFrame: DataFrame): Unit = {
    ...
    sparkSession.sql("use "+properties.getProperty("hive.database"))
  ...
  def mockUserAction() = {
    ...
    val startDate = new SimpleDateFormat("yyyy-MM-dd").parse("2020-02-17")
    val endDate = new SimpleDateFormat("yyyy-MM-dd").parse("2020-02-19")
